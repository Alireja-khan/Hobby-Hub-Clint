...
const DashCreateGroup = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 sm:mt-14 md:mt-20 px-4 sm:px-6 md:px-10 py-8 sm:py-10 bg-white rounded-2xl   ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="text-center mt-10 sm:mt-12">
              <button
                type="submit"
                className="w-full bg-blue-100 hover:bg-blue-200 sm:w-auto hover:shadow-2xl text-base sm:text-lg font-semibold py-3 px-36 rounded-xl shadow transition duration-300"
              >
                Create Group
              </button>
            </div>
