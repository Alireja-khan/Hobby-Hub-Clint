        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="relative bg-gradient-to-r from-gray-100 to-gray-300 min-h-[600px] px-6 py-20 rounded-b-3xl shadow-xl overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div className="absolute inset-0 bg-[url('https://i.ibb.co/5Wwmjy0s/Group-therapy-cuate.png')] bg-cover bg-center opacity-40"></div>
                </div>
            ...
            <section className="bg-white py-16 px-6 sm:px-10 lg:px-20 text-center">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto text-lg leading-relaxed">
                    Welcome to our hobby community! We connect like-minded individuals through shared interests — whether it's art,
                    coding, photography, or gaming. Join us to learn, collaborate, and have fun with others who share your passion.
                </p>
            </section>
        </div>
    );
