                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col justify-between h-full">
                            <div>
                                ...
                                <p className="flex mb-2 items-center gap-2"><MdDescription /> <span className="font-semibold">Description:</span> {group.description}</p>

                                <Link to={`/groupDetails/${group._id}`}>
                                    <button className=" w-full mt-5 hover:shadow-2xl text-black font-bold py-3 px-6 rounded-xl shadow transition duration-300 ease-in-out">
                                        View Details
                                    </button>
                                </Link>
                            </div>
